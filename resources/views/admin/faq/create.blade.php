...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
    <h1 style="margin: 0; color: var(--hijau-islam);">Tambah FAQ</h1>
...
<div style="max-width: 700px;">
    <form method="POST" action="{{ route('admin.faq.store') }}" style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea id="jawaban" name="jawaban" required>{{ old('jawaban') }}</textarea>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            ...
            <div class="form-group">
                ...
                <input type="number" id="urutan" name="urutan" value="{{ old('urutan', 0) }}" min="0" required>
            </div>
        </div>
