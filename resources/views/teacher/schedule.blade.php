...
<div class="schedule-page">
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        ...
        <div>
            <button class="btn btn-primary" onclick="window.print()" style="min-height: 46px; border-radius: 12px; font-weight: 600; padding: 0 24px; background: var(--primary); border-color: var(--primary); color: #ffffff; display: inline-flex; align-items: center; gap: 8px;">
