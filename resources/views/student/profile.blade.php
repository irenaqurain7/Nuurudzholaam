...
<h1 class="h2 mb-4">Profil & Data Saya</h1>
            ...
            <div class="card-body">
                <form action="{{ route('student.profile.update') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nisn" value="{{ auth()->user()->nisn ?? '-' }}" disabled>
                        <small class="text-muted">NISN tidak dapat diubah</small>
                    </div>

                    <div class="mb-3">
                        <label for="class" class="form-label">Kelas</label>
                        <input type="text" class="form-control" id="class" value="{{ auth()->user()->class ?? '-' }}" disabled>
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                ...
                @endif
                <div class="mt-3">
                    <a href="{{ route('student.upload-photo') }}" class="btn btn-outline-primary btn-sm">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('student.change-password') }}" class="btn btn-outline-secondary btn-sm w-100">
